...
And 40+ more. View the [complete list of supported connectors](/resources/agent-connectors).
...
<CardGroup cols={2}>
  <Card title="Quickstart guide" icon="rocket" href="/guides/agent-authentication">
    Connect to Gmail in 5 minutes
  </Card>
  
  <Card title="Supported providers" icon="plug" href="/resources/agent-connectors">
    View all 60+ supported integrations
  </Card>
  
  <Card title="Code samples" icon="github" href="/resources/code-samples">
