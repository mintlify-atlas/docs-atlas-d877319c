...
<CardGroup cols={2}>
  <Card title="Quickstart guide" icon="rocket" href="/guides/scim-provisioning">
    Set up SCIM provisioning in 30 minutes
  </Card>
  
  <Card title="SCIM integrations" icon="book" href="/resources/scim-integrations">
    Browse SCIM provider integrations
  </Card>
  
  <Card title="Webhook events" icon="webhook" href="/api/webhooks/events">
    View all directory webhook events
  </Card>
  
  <Card title="API Reference" icon="code" href="/api/scim/users">
