...
[Auth0 integration guide](/guides/integrations/auth-systems/auth0/)
...
[Firebase integration guide](/guides/integrations/auth-systems/firebase/)
...
[AWS Cognito integration guide](/guides/integrations/auth-systems/aws-cognito/)
...
[Complete testing guide](/sso/guides/test-sso/)
...
<CardGroup cols={2}>
  <Card title="Quickstart guide" icon="rocket" href="/sso/quickstart">
    Add enterprise SSO in 30 minutes
  </Card>
  
  <Card title="SSO basics" icon="book" href="/sso/guides/sso-basics">
    Learn how SAML and OIDC work
  </Card>
  
  <Card title="Test SSO" icon="flask" href="/sso/guides/test-sso">
    Test your SSO integration
  </Card>
  
  <Card title="Admin portal" icon="cog" href="/guides/admin-portal">
