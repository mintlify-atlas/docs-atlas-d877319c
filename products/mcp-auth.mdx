...
[FastMCP quickstart guide](/authenticate/mcp/fastmcp-quickstart)
...
<CardGroup cols={2}>
  ...
  <Card title="FastMCP quickstart" icon="zap" href="/authenticate/mcp/fastmcp-quickstart">
    Add auth to FastMCP in 5 lines of code
  </Card>
...
<Note>
  For FastMCP users: Use the Scalekit plugin to add authentication in just 5 lines of code. [See the FastMCP quickstart](/authenticate/mcp/fastmcp-quickstart).
</Note>